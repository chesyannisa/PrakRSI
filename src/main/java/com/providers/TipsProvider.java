...
public class TipsProvider {
    public Tips getTipsById(int id) {
        ...
        if (id == 3) return new Tips(3, "Mengenal Sustainable Living: Contoh, Tips, dan Manfaatnya", "Prudential", "src\\\\main\\\\resources\\\\images\\\\art3.jpg","https://www.prudential.co.id/id/pulse/article/sustainable-living/");
